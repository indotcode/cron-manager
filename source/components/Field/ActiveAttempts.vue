<template>
    <div>
        <label class="block mb-3">
            ...
            <Field name="de_active_attempts" v-model="de_active_attempts" :value="de_active_attempts" type="number" :rules="rules" class="form-input mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" />
