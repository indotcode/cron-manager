<template>
    <div class="flex flex-wrap">
        <label class="pr-4 w-4/12">
            ...
            <Field placeholder="Введите минуту" v-model="params[0]" name="params[0]" type="number" :rules="roles"  class="form-input mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" />
